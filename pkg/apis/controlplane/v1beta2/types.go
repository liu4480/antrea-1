...
type Service struct {
	...
	// +optional
	IGMPType     *string  `json:"igmpType,omitempty" protobuf:"bytes,6,opt,name=igmpType"`
	GroupAddress *IPBlock `json:"groupAddress,omitempty" protobuf:"bytes,7,opt,name=groupAddress"`
}
