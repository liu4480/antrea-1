...
func (c *Controller) comparePriority(r1, r2 *rule) bool {
	p1, p2 := &types.Priority{RulePriority: r1.Priority}, types.Priority{RulePriority: r2.Priority}
	if r1.TierPriority != nil {
		p1.TierPriority = *r1.TierPriority
	}
	if r1.PolicyPriority != nil {
		p1.PolicyPriority = *r1.PolicyPriority
	}
	if r2.TierPriority != nil {
		p2.TierPriority = *r2.TierPriority
	}
