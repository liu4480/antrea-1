...
func TestValidate(t *testing.T) {
	...
	item, err := controller.Validate("pod1", "ns1", net.ParseIP(groupAddress1), 0x12, v1beta2.DirectionOut)
	if err != nil {
	...
	item, err = controller.Validate("pod1", "ns1", net.ParseIP(groupAddress2), 0x12, v1beta2.DirectionOut)
	if err != nil {
